...
$sql = "
  ...
  WHERE p.estado = 'Concluído'
    AND p.tipo_projeto = 'residenciais'
...
<head>
  ...
  <title>Portfolio Residenciais - SupremeXpansion</title>
...
<section class="portfolio-content">
  <?php if (empty($projetos)): ?>
    <p style="color:#fff; text-align:center; width:100%;">Ainda não existem projetos residenciais concluídos.</p>
  <?php else: ?>
