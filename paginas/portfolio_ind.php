...
$sql = "
  ...
  WHERE p.estado = 'Concluído'
    AND p.tipo_projeto = 'industriais'
...
<head>
  ...
  <title>Portfolio Industriais - SupremeXpansion</title>
...
<section class="portfolio-content">
  <?php if (empty($projetos)): ?>
    <p style="color:#fff; text-align:center; width:100%;">Ainda não existem projetos industriais concluídos.</p>
  <?php else: ?>
