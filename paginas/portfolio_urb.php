...
<head>
  ...
  <title>Portfolio Urbanos - SupremeXpansion</title>
...
<section class="portfolio-content">
  <?php if (empty($projetos)): ?>
    <p style="color:#fff; text-align:center; width:100%;">Ainda não existem projetos urbanos concluídos.</p>
  <?php else: ?>
