...
$titulo = "Linhas de Vapor em Cardiff UK";
$capa   = "../img/img16.png";          // a capa (e também fundo do topo)
$pasta  = "../ficheiros_pj/projeto7";     // pasta local deste ficheiro com imagens da página
