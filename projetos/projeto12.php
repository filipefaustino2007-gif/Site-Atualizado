...
$titulo = "Ruína";
$capa   = "../img/img8.png";          // a capa (e também fundo do topo)
$pasta  = "../ficheiros_pj/projeto12";     // pasta local deste ficheiro com imagens da página
...
<head>
  ...
  <style>
    ...
    /* últimas 2: 2 por fila (metade/metade) */
