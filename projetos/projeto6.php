...
$titulo = "Levantamento Armazém";
$capa   = "../img/img11.png";          // a capa (e também fundo do topo)
$pasta  = "../ficheiros_pj/projeto6";     // pasta local deste ficheiro com imagens da página
...
<head>
  ...
  <style>
    ...
    /* última imagem (7ª) ocupa a linha toda */
    .pp-galeria > img:last-child{
      grid-column: 1 / -1;   /* ocupa as 3 colunas */
      height: 520px;         /* maior para "preencher" */
    }

    @media (max-width: 900px){
      .pp-galeria{ grid-template-columns: repeat(2, 1fr); }
      .pp-galeria > img{ height: 260px; }
      .pp-galeria > img:last-child{ grid-column: 1 / -1; height: 380px; }
    }

    @media (max-width: 520px){
      .pp-galeria{ grid-template-columns: 1fr; }
      .pp-galeria > img{ height: 240px; }
      .pp-galeria > img:last-child{ height: 300px; }
    }
  </style>
</head>
<body>
